...
__all__ = ["D2FPSingleHumanTestDatasetMapper"]


class D2FPSingleHumanTestDatasetMapper:
    @configurable
    def __init__(
        self,
        is_train,
        *,
        ...
        logger.info(
            f"[D2FPSingleHumanTestDatasetMapper] Augmentations used in {mode}: self.implemented center_to_target_size"
        )
