...
def build_pixel_decoder(cfg, input_shape):
    """
    Build a pixel decoder from `cfg.MODEL.D2FP.PIXEL_DECODER_NAME`.
    """
...
class TransformerEncoderPixelDecoder(BasePixelDecoder):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret["transformer_dropout"] = cfg.MODEL.D2FP.DROPOUT
        ret["transformer_nheads"] = cfg.MODEL.D2FP.NHEADS
        ret["transformer_dim_feedforward"] = cfg.MODEL.D2FP.DIM_FEEDFORWARD
        ret[
            "transformer_enc_layers"
        ] = cfg.MODEL.SEM_SEG_HEAD.TRANSFORMER_ENC_LAYERS  # a separate config
        ret["transformer_pre_norm"] = cfg.MODEL.D2FP.PRE_NORM
        return ret
