...
class D2FP(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        # Loss parameters:
        deep_supervision = cfg.MODEL.D2FP.DEEP_SUPERVISION
        no_object_weight = cfg.MODEL.D2FP.NO_OBJECT_WEIGHT

        # loss weights
        class_weight = cfg.MODEL.D2FP.CLASS_WEIGHT
        dice_weight = cfg.MODEL.D2FP.DICE_WEIGHT
        mask_weight = cfg.MODEL.D2FP.MASK_WEIGHT
        ...
        matcher = HungarianMatcher(
            ...
            num_points=cfg.MODEL.D2FP.TRAIN_NUM_POINTS,
        )

        weight_dict = {"loss_ce": class_weight, "loss_mask": mask_weight, "loss_dice": dice_weight}

        if deep_supervision:
            dec_layers = cfg.MODEL.D2FP.DEC_LAYERS
            aux_weight_dict = {}
        ...
        criterion = SetCriterion(
            ...
            losses=losses,
            num_points=cfg.MODEL.D2FP.TRAIN_NUM_POINTS,
            oversample_ratio=cfg.MODEL.D2FP.OVERSAMPLE_RATIO,
            importance_sample_ratio=cfg.MODEL.D2FP.IMPORTANCE_SAMPLE_RATIO,
        )
        ...
        return {
            ...
            "criterion": criterion,
            "num_queries": cfg.MODEL.D2FP.NUM_OBJECT_QUERIES,
            "object_mask_threshold": cfg.MODEL.D2FP.TEST.OBJECT_MASK_THRESHOLD,
            "overlap_threshold": cfg.MODEL.D2FP.TEST.OVERLAP_THRESHOLD,
            "metadata": MetadataCatalog.get(cfg.DATASETS.TRAIN[0]),
            "size_divisibility": cfg.MODEL.D2FP.SIZE_DIVISIBILITY,
            "sem_seg_postprocess_before_inference": (
                    cfg.MODEL.D2FP.TEST.SEM_SEG_POSTPROCESSING_BEFORE_INFERENCE
                    or cfg.MODEL.D2FP.TEST.PARSING_ON
            ),
            "pixel_mean": cfg.MODEL.PIXEL_MEAN,
            "pixel_std": cfg.MODEL.PIXEL_STD,
            # inference
            "semantic_on": cfg.MODEL.D2FP.TEST.SEMANTIC_ON,
            "parsing_on": cfg.MODEL.D2FP.TEST.PARSING_ON,
            "test_topk_per_image": cfg.TEST.DETECTIONS_PER_IMAGE,
            "single_human": True if "lip" in cfg.DATASETS.TEST[0] else False,
            "with_human_instance": cfg.MODEL.D2FP.WITH_HUMAN_INSTANCE,
            "parsing_ins_score_thr": cfg.MODEL.D2FP.TEST.PARSING_INS_SCORE_THR
        }
